...
$_['entry_affiliate']            = '联盟条款：<br /><span class="help">创建联盟账户用户必须同意的条款。</span>';
$_['entry_commission']           = '联盟账户佣金(%)：<br /><span class="help">默认联盟账户佣金百分比。</span>';
...
$_['entry_fraud_detection']      = '使用MaxMind欺诈检测系统：<br /><span class="help">MaxMind是一个欺诈检测服务。如果你没有一个许可证密钥，您可以<a href="http://www.maxmind.com/?rId=opencart" target="_blank"><u>注册这里</u></a>。一旦你已经获得了Key，请复制并粘贴到下面。</span>';
...
$_['entry_file_extension_allowed'] = '允许上传的文件扩展名：<br /><span class="help">增加允许上传文件扩展名，一行填入一个值。</span>';
$_['entry_file_mime_allowed']    = '允许文件类型：<br /><span class="help">增加被允许的类型文件上传，每行填入一个值。</span>';
$_['entry_maintenance']          = '系统维护模式：<br /><span class="help">本功能将在前台首页显示系统维护信息。 但在后台您可以正常使用本系统。</span>';
...
$_['entry_google_analytics']     = 'Google Analytics Code：<br /><span class="help">登录您的<a href="http://www.google.com/analytics/" target="_blank"><u>Google Analytics</u></a>账户，后创建您的网店概述拷贝粘贴统计代码到框内。</span>';
